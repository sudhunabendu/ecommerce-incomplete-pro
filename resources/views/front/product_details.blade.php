...
@section('page_title','Grocery Product Details')
@section('container')
				...
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
						      @php
									$i = 1;
									$image = json_decode($product->filenames,true)
									@endphp
							   ...
							   <li data-thumb="images/se1.jpg">							
								 <div class="thumb-image">
									<img src="{{url('files/'.$image)}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
						    	</li>
						    	@endif
									@php
                  $i--;
					...
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						...
						@csrf
							<fieldset>
								...
								<input type="number"  min="1" max="100" class="form-control" name="quantity" value="1" required/><br>
