				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('front_assets/images/d2.jpg')}}" alt="">
						</div>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('front_assets/images/d1.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('front_assets/images/d4.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Tata Salt</h3>
							<a href="#">$15.00</a>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('front_assets/images/d5.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('front_assets/images/d3.jpg')}}" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
