	...
	<div class="header-bot">
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="/">
						<span>G</span>rocery
						<span>S</span>hoppy
						<img src="{{asset('front_assets/images/logo2.png')}}" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
          ...
          <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
					<span class="fa fa-id-badge" aria-hidden="true">
					...
					<div class="container-fluid">
                      ...
                      @foreach(App\Models\Category::orderBy('category_name','asc')->get() as $cate)
												<ul class="multi-column-dropdown">
													<li>
														<a href="{{route('categories.show',$cate->id)}}">{{$cate->category_name}}</a>
													</li>
												</ul>
												@endforeach
											</div>
								...
								<li class="">
									<a class="nav-stylehead" href="{{url('/products')}}">Products</a>
								</li>
								<li class="dropdown">
